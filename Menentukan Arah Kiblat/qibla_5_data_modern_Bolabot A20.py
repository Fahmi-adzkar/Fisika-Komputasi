...
print('-----Laboratorium Bolabot Robotic Institute Bandung-----')
...
#Lintang Lab. Bolabot Bandung, Indonesia
LB = -6.92892 #Lintang dalam Desimal
Cos_LB = cos(radians (LB)) #Cos Lintang Bandung
Sin_LB = sin(radians (LB)) #Sin Lintang Bandung

#Bujur Lab. Bolabot Bandung, Indonesia
BB = 107.71673 #Bujur dalam Desimal
